                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-center w-[30%] gap-[6px]">
                          <button
                            className={`rounded-[15px] py-[6px] sm:px-5 px-3 text-[12px] font-medium ${
                              [0, 1, 2].includes(getRole()!)
                                ? "text-[#FF3B30] bg-[#DB2C2C1A]"
                                : "text-[#9e9e9e] bg-[#e9e8e8] cursor-not-allowed"
                            }`}
                            onClick={() => {
                              if (!deleteLoader) {
                                deleteProjectTypes(
                          ...
                          <button
                            className={`rounded-[30px] py-[6px] sm:px-5 px-3  text-[12px] font-medium ${
                              [0, 1, 2].includes(getRole()!)
                                ? "text-[#23b4a6] bg-[#48C1B54D]"
                                : "text-[#9e9e9e] bg-[#e9e8e8] cursor-not-allowed"
                            }`}
                            onClick={() => {
                              setEditedPT(project);

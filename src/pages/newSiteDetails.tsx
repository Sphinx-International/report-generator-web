...
import { ResOfOneNewSiten } from "../assets/types/NewSite";
...
const NewSiteDetails = () => {
  ...
  const [newSite, setNewSite] = useState<ResOfOneNewSiten | null>(null);
  ...
  const [basicDataNewSite, setbasicDataNewSite] = useState<{
    title: string;
    id: string;
    priority: 0 | 1 | 2 | 3 | number;
    description: string;
  ...
  }, [spanRef, basicDataNewSite.title]);

  const handleExecute = (newSite_id: string) => {
  ...
  const fetchOneNewSite = useCallback(async () => {
    const token =
        ...
        case 200:
          {
            ...
            setNewSite(data);
            setbasicDataNewSite({
              title: data.new_site.title,
              id: data.new_site.id,
              priority: data.new_site.priority,
              description: data.new_site.description,
            });
            setSelectedMembersFromGroup(() => {
              // Extract emails from data.newSite.mail_to
            ...
            await syncIndexedDBWithFetchedFiles(data.new_site.id, data);
          }
          break;
  ...
  return (
    <div className="w-full flex h-[100vh]">
            ...
            <div className="flex flex-col w-full gap-[31px] ">
              <div className="flex flex-col gap-[31px] md:border-[1px] md:border-n400 rounded-[20px] md:px-[25px] md:py-[32px]">
                <div className="w-full flex items-center justify-between gap-[14px] ">
                  <div className="flex items-center sm:gap-[12px] w-[90%] text-primary font-semibold md:text-[24px] text-[17px]">
                    <>
                      ...
                      >
                        {`${basicDataNewSite.title} | ${basicDataNewSite.id}`}
                      </span>
                      ...
                      <input
                        ...
                        value={
                          isEditing_Title_tic
                            ? `${basicDataNewSite.title}`
                            : `${basicDataNewSite.title}    ${basicDataNewSite.id}`
                        }
                        onChange={(e) => {
                          handleChange(e, setbasicDataNewSite);
                        }}
                      />
                    </>
                    {isEditing_Title_tic && (
                  ...
                  {newSite.history !== null && newSite.history.length !== 0 && (
                    <div className="relative">
                      ...
                      {visibleHistory && (
                        <div className="bg-white py-[19px] px-[26px] rounded-[20px] shadow-xl shadow-slate-300 absolute right-0 flex flex-col items-start z-50 max-h-[60vh] overflow-auto">
                          {newSite.history.map((action, index) => {
                            return (
                              <div
                                key={index}
                                className={`flex flex-col items-start gap-1 py-[10px] ${
                                  ++index !== newSite.history.length &&
                              ...
                              >
                                <h6 className="text-[13px] leading-5 font-medium text-n800 text-nowrap">
                                  {action.action === 0
                                    ...
                                    : action.action === 2
                                    ? "new site has been assigned"
                                    : action.action === 3
                                    ? "new site has been reassigned"
                                    : action.action === 4
                                    ? "new site has been executed"
                                    : action.action === 5
                                    ? "new site report uploaded"
                                    : action.action === 6
                                    ? "new site has been reported"
                                    : action.action === 7
                                    ? "new site update requested"
                                    : action.action === 8
                                    ? "new site certificate uploaded"
                                    : action.action === 9
                                    ? "new site has been accepted"
                                    : "new site closed"}
                                </h6>
                ...
                <div className="w-full flex flex-col items-start gap-[15px]">
                  {newSite.new_site.assigned_to !== null ? (
                    <div className="flex items-center gap-[12px] relative">
                      ...
                      <span className="sm:text-[18px] text-[15px] text-n600 font-medium leading-[27px]">
                        {newSite.new_site.assigned_to.email}
                      </span>
                      {visibleEngPopup && (
                  ...
                  <div className="flex flex-col gap-[10px] items-start w-full">
                    ...
                    <textarea
                      ...
                      value={basicDataNewSite.description}
                  ...
                  <div className="flex items-center gap-[4px]">
                                ...
                                typeOfSearchForCoord === "Emails" ? (
                                  searchCoords.map((user, index) => (
                                    <div
                                      ...
                                      className="flex items-center gap-[5px] cursor-pointer w-full hover:bg-n300"
                                      onClick={() => {
                                        // Check if the email exists in newSite.mail_to
                                        const emailExists =
                                          newSite.mail_to.some(
                                            (mailTo) =>
                    ...
                    {newSite.mail_to &&
                      newSite.mail_to.map((mail, index) => {
                        return (
                  ...
                  <div className="flex items-center gap-[8px] relative">
                    <WorkOrderStatus
                      status={
                        ...
                        newSite.new_site.certificate_status === 1 &&
                        newSite.new_site.is_certificate_file_uploaded &&
                        newSite.new_site.is_report_file_uploaded
                          ? 3
                          : newSite.new_site.status
                      }
                    ...
                    <div className="relative">
                      ...
                      <span
                        className={`cursor-pointer rounded-[100px] text-[13px] font-medium leading-[15px] bg-[#FEF6FF] py-[9.5px] px-[28px] ${
                          basicDataNewSite.priority === 0
                            ? "text-primary"
                            : basicDataNewSite.priority === 1
                            ? "text-[#DB2C9F]"
                            : basicDataNewSite.priority === 2
                            ? "text-[#FFAA29]"
                            : "text-[#DB2C2C]"
                        }`}
                        onClick={() => {
                      ...
                      {showPriority && (
                        <div className="p-[20px] md:rounded-tl-[17px] md:rounded-tr-[0px] rounded-tr-[17px] rounded-bl-[17px] rounded-br-[17px] bg-white shadow-lg z-30 absolute flex flex-col items-start gap-[27px] left-2 top-10">
                                ...
                                return (
                                  <span
                                    ...
                                    className={`cursor-pointer rounded-[100px] py-[4.5px] sm:px-[20px] px-[15px] leading-[15px] sm:text-[10px] text-[9px] font-medium ${
                                      index === 0
                                        ? index === basicDataNewSite.priority
                          ...
                          {newSite.new_site.priority !==
                            basicDataNewSite.priority && (
                            <div className="flex items-center gap-[6px] w-full">
                              <button
                                ...
                                onClick={() => {
                                  setbasicDataNewSite((prev) => ({
                                    ...prev,
                                    priority: newSite.new_site.priority,
                                  }));
                                  setShowPriority(false);
                                }}
                              >
                              ...
                              <button
                                ...
                                onClick={() => {
                                  handleEditWorkorder({
                                    id: newSite.new_site.id,
                                    priority: basicDataNewSite.priority,
                                  });
                                }}
                              >
                                Save
                    ...
                    {newSite.reports && newSite.reports?.length > 0 ? (
                      <WorkOrderStatus
                        status={
                          newSite.new_site.is_report_file_uploaded === false
                            ? "onUpRep"
                        ...
                        <div className="flex gap-[20px] flex-wrap">
                          ...
                          {uploadedAttachOnCreation.length !== 0 &&
                            uploadedAttachOnCreation
                              .filter(
                                (attach) =>
                                  attach.workorder === newSite.new_site.id
                              )
                              .map((attach, index) => {
                                return (
                                  <div
                  ...
                  <div className="flex items-center justify-end gap-[6px] w-full">
                    <button
                      ...
                      onClick={() => {
                        ...
                        setbasicDataNewSite((prev) => ({
                          ...prev,
                          title: newSite.new_site.title,
                          description: newSite.new_site.description,
                          id: newSite.new_site.id,
                        }));
                      }}
                    >
                    ...
                    <button
                      ...
                      onClick={() => {
                        handleEditWorkorder({
                          title: basicDataNewSite.title,
                          id: basicDataNewSite.id,
                          description: basicDataNewSite.description,
                        });
                      }}
                    >
                      Save
                  ...
                  <>
                    ...
                    <div className="w-full flex flex-col gap-[15px] md:border-[1px] md:border-n400 rounded-[20px] md:px-[25px] md:py-[32px]">
                      ...
                      <div className="flex w-full items-center flex-wrap gap-[16px]">
                        ...
                        {newSite.new_site.status < 3 &&
                          newSite.acceptance_certificates !== undefined &&
                          (newSite.acceptance_certificates === null ||
                            (newSite.acceptance_certificates.length > 0 &&
                              newSite.acceptance_certificates[
                                newSite.acceptance_certificates.length - 1
                              ].type !== 1)) && (
                      ...
                      <div className="w-full flex flex-col gap-[15px]">
                        ...
                        <div className="flex w-full items-center flex-wrap gap-[16px]">
                          {newSite.return_vouchers &&
                            newSite.return_vouchers.length > 0 &&
                            newSite.return_vouchers
                              .filter((voucher) =>
                                  ...
                                  >
                                    <div className="flex items-center gap-[9px] w-full">
                                      ...
                                      <div className="flex flex-col items-start w-full relative">
                                        ...
                                        >
                                          {formatDate(`${voucher.uploaded_at}`)}
                                        </span>
      ...
      <AddCertificatPopup
        ...
        workorderId={newSite?.new_site.id}
        extantionType="new-site"
        fetchOneWorkOrder={fetchOneNewSite}
      />
      <AddReportPopup

        ...
        <main className="w-full flex flex-col gap-[20px] rounded-[20px] border-n300 border-[1px] p-[25px]">
          <div className="w-full flex items-center justify-between py-[6px]">
            ...
            <span
              ...
              aria-disabled={selectedIndividuals.length === 0 ? true : false}
            ...
            >
              ...
              >
                <path
                  ...
                  fill={`${
                    selectedIndividuals.length === 0 ? "#6F6C8F" : "#df0505"
                  }`}
                />
              </svg>
            </span>
          ...
          <div className={`flex items-center gap-x-[13px] gap-y-[18px] w-full flex-wrap py-[16px] }`}>
          {Array.from({ length: 8 }).map((_, index) => {
            return (
              <div
                key={index}
                className="flex items-center gap-[12px] rounded-[22px] py-[7px] px-[11px] border-[1px] border-n300"
              >

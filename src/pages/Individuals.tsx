  ...
  return (
    <div className="w-full flex md:h-[100vh]">
      ...
      <div className="lg:pl-[26px] md:pt-[32px] pt-[20px] lg:pr-[30px] sm:px-[30px] px-[15px] pb-[20px] flex flex-col gap-[26px] w-full md:h-[100vh] overflow-y-auto">
        ...
        />
        <SearchBar
          openDialogRef={addEmailDialogRef}
          page="mails"
          wsUrl="search-mail"
          setSearchResult={setWsMails}
        ...
        <main className="w-full flex flex-col gap-[20px] rounded-[20px] border-n300 border-[1px] sm:p-[25px] p-[16px]">
          ...
          {isLoading ? (
            ...
            </div>  :               <div className="flex flex-col gap-6 items-center justify-center">
              <img
                src="/astronaut/astro1.png"
                alt="astro"
                className="w-[230px]"
              />

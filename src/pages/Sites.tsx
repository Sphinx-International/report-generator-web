...
const Sites = () => {
  ...
  const handleCheckboxChange = (userId: string) => {
    dispatch(toggleSitesInTab(userId));
  };
  ...
  return (
    <div className="w-full flex md:h-[100vh]">
      ...
      <div className="lg:pl-[26px] md:pt-[32px] pt-[20px] lg:pr-[30px] sm:px-[30px] px-[15px] pb-[20px] flex flex-col gap-[26px] w-full md:h-[100vh] overflow-y-auto">
        ...
        />
        <SearchBar openDialogRef={createSite} page="Sites" wsUrl="" setSearchResult={setSites} setLoaderSearch={setIsloading}/> 
              ...
              {!isloading ? (
                <div className="flex flex-col h-[100%] overflow-y-auto">
                  {Array.from({ length: 6 }).map((_, index) => {
                    const isSelected = selectedSites.includes(String(index));
                    return (
                      <div
                        key={index}
                      ...
                      >
                        ...
                        <input
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            handleCheckboxChange(String(index));
        ...
        <CreateSitePopup ref={createSite}/>
      </div>{" "}
    </div>
  );
};

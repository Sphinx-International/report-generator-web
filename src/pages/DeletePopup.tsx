...
const DeletePopup = forwardRef<HTMLDialogElement>((_, ref) => {
  return (
    <dialog
      ref={ref}
      id="User-popup"
    ...
    >
      ...
      <div className="flex items-center gap-[6px]">
        <button className="text-white px-[56px] py-[12.5px] rounded-[86px] bg-[#FF3B30] text-[14px]">Yes </button>
        <button className="text-n600 px-[56px] py-[12.5px] rounded-[86px] bg-n300 text-[14px] border-[1px] border-n400"
                onClick={() => {

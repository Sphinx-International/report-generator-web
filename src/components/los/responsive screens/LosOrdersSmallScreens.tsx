...
const LosOrdersSmallScreens: React.FC<LosOrdersSmallScreensProps> = ({
  order,
  setSelectedSiteInfo,
  executeLosPopupRef,
  openDropdownIndex,
  ...
  if (order) {
    return (
      <div className="flex flex-col gap-3 w-full px-[25px] lg:hidden">
        {order.alternative_far_ends.map((alt, index) => {
          return (
            <div
              key={index}
              className={`flex items-center justify-center gap-y-14 gap-x-8 flex-wrap w-full border-[1px] border-[#E6EDFF] rounded-[20px] py-6 px-3  ${
            ...
            >
              ...
              <div className="flex flex-col items-center gap-3">
                <span className="text-n800 font-medium text-[13x]">
                  Azimuth NE to FE
                </span>
                <div className="w-fit flex items-center justify-center">
                  <span
                ...
                <div className="w-fit flex items-end gap-3 justify-center">
                  ...
                  <div className="relative">
                    ...
                    {openDropdownIndex === index && (
                      <div className="absolute right-0 flex flex-col items-center gap-[10px] z-40 bg-white shadow-lg shadow-slate-300 rounded-[22px] p-4">
                        {alt.los_status !== 1 && (
                          <span
...
export default LosOrdersSmallScreens;

  ...
  ({ setCurrentSliderIndex, site }) => {
    ...
    setFile({ file: file, progress: 0 });  
        ...
        <div className="flex items-center gap-[6px]">
          ...
          <button
            className="rounded-[86px] px-[25px] sm:px-[45px] py-[7px] sm:py-[10px] bg-primary text-[14px] text-white font-semibold border-[1px] border-primary flex items-center justify-center"
